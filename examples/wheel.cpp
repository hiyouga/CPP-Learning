...
inline int ones(int num1) { int ctt = 0; while(num1 && ++ctt) num1-=num1&(-num1); return ctt; }
template<class tests> void chmax(tests & num1, const tests & bin) { num1 = max(num1, bin); }
template<class tests> void chmin(tests & num1, const tests & bin) { num1 = min(num1, bin); }
